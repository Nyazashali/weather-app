...
const API_KEY = '4e80f5f452fa72baa28b69519180111d';
  ...
  return (
    <div className="min-h-screen relative bg-cover bg-center bg-[url('https://cdn.pixabay.com/photo/2023/07/25/18/42/vector-graphic-8149677_1280.jpg')]">
      ...
      <div className="z-50 w-full h-screen flex items-center justify-center gap-16">
        ...
        <div className="bg-blue-500/20 backdrop-blur-lg p-6 rounded-xl border border-neutral-200/20 shadow-md w-full max-w-md">
          {/* Title */}
          ...
          {/* Search Input */}
          <div className="w-full h-14 mb-4 flex items-center gap-x-3 px-4 py-3 text-lg rounded-xl bg-transparent border border-neutral-400 text-neutral-200 focus:outline-none">
          ...
          <button
            ...
            className="w-full bg-green-400 hover:bg-green-600  p-6 text-base font-medium rounded-xl transition duration-200"
          >
            Search
          </button>
        </div>
        ...
        {weather && !error && !loading && (
          <div className="mt-8 bg-blue-500/20 backdrop-blur-lg p-6 rounded-lg flex items-center justify-center flex-col border border-neutral-200/20 shadow-md w-full max-w-sm">
